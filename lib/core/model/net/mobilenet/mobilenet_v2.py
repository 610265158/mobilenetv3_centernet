...
from lib.core.model.net.mobilenet import conv_blocks as ops
from lib.core.model.net.mobilenet import mobilenet as lib
...
mobilenet_v2_025 = wrapped_partial(mobilenet, depth_multiplier=0.25,
                                   finegrain_classification_mode=True)
