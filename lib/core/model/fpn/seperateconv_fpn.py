...
def create_fpn_net(blocks,dims_list):
    ...
    p5 = slim.separable_conv2d(p5, dims_list[1], [3, 3],padding='SAME',scope='P5')
    ...
    p4 = slim.separable_conv2d(p4, dims_list[1], [3, 3],padding='SAME',scope='P4')

    p3 = slim.conv2d(c3, dims_list[0], [1, 1], padding='SAME', scope='C3_reduced')
    p3 = p3 + p4_upsampled
    p3 = slim.separable_conv2d(p3, dims_list[1], [3, 3], padding='SAME', scope='P3')
