...
config.TRAIN.epoch = 100                      ###just keep training , evaluation shoule be take care by yourself,
                                               ### generally 10,0000 iters is enough

config.TRAIN.train_set_size=13000              ###widerface train size
config.TRAIN.val_set_size=1500             ###widerface val size
...
config.DATA.cover_small_face=12                          ###cover the small faces
...
config.ANCHOR.ANCHOR_SIZES = (32,128,320)   # sqrtarea of the anchor box
...
config.MODEL.fpn_dims=[96,128,128]
